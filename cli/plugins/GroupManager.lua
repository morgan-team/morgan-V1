--Begin GroupManager.lua By @shiekh_mamad
...
local function delmsg (MaTaDoR,shiekh_mamad)
    msgs = MaTaDoR.msgs 
    for k,v in pairs(shiekh_mamad.messages_) do
        msgs = msgs - 1
        tdcli.deleteMessages(v.chat_id_,{[0] = v.id_}, dl_cb, cmd)
        if msgs == 1 then
            tdcli.deleteMessages(shiekh_mamad.messages_[0].chat_id_,{[0] = shiekh_mamad.messages_[0].id_}, dl_cb, cmd)
            return false
        end
    end
    tdcli.getChatHistory(shiekh_mamad.messages_[0].chat_id_, shiekh_mamad.messages_[0].id_,0 , 100, delmsg, {msgs=msgs})
end
...
if not lang then
 return "》*#lø¢κ* _ρøšт łš αlяeαđч lø¢κeđ_🔒\n*〰〰〰〰〰〰〰〰*\n*øяđeявч*: [@"..check_markdown(msg.from.username or "shiekh_mamad").."]"
elseif lang then
 return "》ارسال #لینک در گروه  از قبلا ممنوع است🔒\n*〰〰〰〰〰〰〰〰*\nسفارش توسط : [@"..check_markdown(msg.from.username or "shiekh_mamad").."]"
end
else
...
if not lang then
text = [[
̶morgan̶ ̶M̶υ̶т̶є̶т̶ι̶м̶є̶ ̶Ƈ̶σ̶м̶м̶α̶η̶ɗ̶ѕ:
